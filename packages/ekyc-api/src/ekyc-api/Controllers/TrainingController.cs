...
namespace ekyc_api.Controllers
{
    ...
    public class TrainingController : ControllerBase
    {
        ...
        public async Task<TrainingJob> CreateTrainingJob()
        {
            ...
            {
                Id = "ekyc-" + Convert.ToInt64(DateTime.UtcNow.Subtract(DateTime.UnixEpoch).TotalSeconds).ToString(),
                StartTime = Convert.ToInt64(DateTime.UtcNow.Subtract(DateTime.UnixEpoch).TotalSeconds),
        ...
        public async Task<string> GetPresignedUploadUrl(string JobId, string S3Key)
        {
            ...
            string realS3Key = $"images/{JobId}/{S3Key}";
